...
public class HttpClientUtils {
    ...
    public static String doPost(String url, Map<String, String> params, Map<String, String> headerMap) {
        String result = null;
        try {
            result = doPost(url, params, CHARSET, defaultConfig, headerMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
    ...
    public static String doPost(String url, String transJson, Map<String, String> headerMap) {
        String result = null;
        try {
            result = doPost(url, transJson, CHARSET, defaultConfig, headerMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
    ...
    private static String doPost(String url, String transJson, String charset, RequestConfig requestConfig, Map<String, String> headerMap) throws Exception {
        try {
            HttpPost httpPost = new HttpPost(url);
            httpPost.setConfig(requestConfig);
            httpPost.setHeader(HTTP.CONTENT_TYPE, "application/json");
    ...
    private static String doPost(String url, Map<String, String> params, String charset, RequestConfig requestConfig, Map<String, String> headerMap) throws Exception {
        try {
            List<NameValuePair> pairs = null;
            if (params != null && !params.isEmpty()) {
                pairs = new ArrayList<NameValuePair>(params.size());
    ...
    public static String doPostPk(String url, Map<String, String> params) throws Exception {
    ...
    public static String doPostMessage(String url, String transJson) {
        try {
            HttpPost httpPost = new HttpPost(url);
            httpPost.setConfig(defaultConfig);
            httpPost.setHeader(HTTP.CONTENT_TYPE, "application/json");
    ...
    public static String doGetSrrpJson(String url) throws Exception {
        try {
            HttpGetRequestBody httpGet = new HttpGetRequestBody(url);
            httpGet.setConfig(defaultConfig);
            httpGet.setEntity(new StringEntity("{}", ContentType.APPLICATION_JSON));
            CloseableHttpResponse response = httpClient.execute(httpGet);
            int statusCode = response.getStatusLine().getStatusCode();
            if (statusCode != 200) {
                httpGet.abort();
    ...
    public static class HttpGetRequestBody extends HttpEntityEnclosingRequestBase {

        public HttpGetRequestBody() {
        }

        public HttpGetRequestBody(URI uri) {
            this.setURI(uri);
        }

        public HttpGetRequestBody(String uri) {
